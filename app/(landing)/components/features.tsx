...
export default function Features() {
  return (
    <div className="space-y-16">
      <section className="mb-28 scroll-mt-28" id="overview">
        <h2 className="text-4xl font-bold text-center pb-20">Overview</h2>
      ...
      <section className="mb-28 scroll-mt-28" id="modifications">
        <h2 className="text-4xl font-bold text-center pb-20">Modifications</h2>
        <div className="relative">
          <div className="sm:inline-flex items-center border backdrop-blur rounded-lg sm:px-4 w-full sm:w-auto sm:h-12 absolute z-10 top-[-24px] left-1/2 transform -translate-x-1/2">
            <p className="sm:text-lg text-center px-2">
      ...
      <section className="mb-28 scroll-mt-28" id="servicing">
        <h2 className="text-4xl font-bold text-center pb-20">Servicing</h2>
        <div className="relative">
          <div className="sm:inline-flex items-center border backdrop-blur rounded-lg sm:px-4 w-full sm:w-auto sm:h-12 absolute z-10 top-[-24px] left-1/2 transform -translate-x-1/2">
            <p className="sm:text-lg text-center px-2">
      ...
      <section className="mb-28 scroll-mt-28" id="settings">
        <h2 className="text-4xl font-bold text-center pb-20">Settings</h2>
        <div className="relative">
          <div className="sm:inline-flex items-center border backdrop-blur rounded-lg sm:px-4 w-full sm:w-auto sm:h-12 absolute z-10 top-[-24px] left-1/2 transform -translate-x-1/2">
            <p className="sm:text-lg text-center px-2">
